namespace VocabLearningService.Migrations
{
    ...
    public partial class Initial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        StudentGroup_Id = c.String(maxLength: 128),
                ...
                c => new
                    {
                        ...
                        TranslatedPhrase = c.String(),
                        ImageURI = c.String(),
                        Assignment_Id = c.String(maxLength: 128),
                        Version = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion",
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
                ...
                c => new
                    {
                        ...
                        StudentGroup_Id1 = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.StudentGroups", t => t.StudentGroup_Id)
                .ForeignKey("dbo.StudentGroups", t => t.StudentGroup_Id1)
                .Index(t => t.StudentGroup_Id)
                .Index(t => t.CreatedAt, clustered: true)
                .Index(t => t.StudentGroup_Id1);
                ...
                c => new
                    {
                        ...
                        Exercise_Id = c.String(maxLength: 128),
                        Version = c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion",
                            annotations: new Dictionary<string, AnnotationValues>
                            {
                                { 
        ...
        {
            DropForeignKey("dbo.StudentExercises", "Student_Id", "dbo.Users");
            DropForeignKey("dbo.StudentExercises", "Exercise_Id", "dbo.Exercises");
            ...
            DropForeignKey("dbo.Assignments", "StudentGroup_Id", "dbo.StudentGroups");
            DropForeignKey("dbo.Exercises", "Assignment_Id", "dbo.Assignments");
            DropIndex("dbo.StudentExercises", new[] { "CreatedAt" });
            DropIndex("dbo.StudentExercises", new[] { "Exercise_Id" });
            DropIndex("dbo.StudentExercises", new[] { "Student_Id" });
            ...
            DropIndex("dbo.StudentGroups", new[] { "CreatedAt" });
            DropIndex("dbo.StudentGroups", new[] { "Teacher_Id" });
            DropIndex("dbo.Exercises", new[] { "CreatedAt" });
            DropIndex("dbo.Exercises", new[] { "Assignment_Id" });
            DropIndex("dbo.Assignments", new[] { "CreatedAt" });
            DropIndex("dbo.Assignments", new[] { "StudentGroup_Id" });
